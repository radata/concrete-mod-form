...
<div id="ccm-formBlockPane-add" class="ccm-formBlockPane" style=" <?php  echo (intval($miniSurveyInfo['bID'])==0)?'display:block':''?> ">
    ...
    <fieldset id="newQuestionBox">
        ...
        <div class="clearfix">
            <?php echo $form->label('question', t('Question EN *'))?>
            <div class="input">
                <?php echo $form->text('question')?>
            </div>
        </div>
        <div class="clearfix">
            <?php echo $form->label('Lpl', t('Question PL *'))?>
            <div class="input">
                <?php echo $form->text('Lpl')?>
            </div>
        </div>
        <div class="clearfix">
            <?php echo $form->label('Lnl', t('Question NL'))?>
            <div class="input">
                <?php echo $form->text('Lnl')?>
            </div>
        </div>
        <div class="clearfix">
            <?php echo $form->label('Les', t('Question ES'))?>
            <div class="input">
                <?php echo $form->text('Les')?>
            </div>
        </div>
        <div class="clearfix">
            <label><?php echo t('Answer Type')?></label>
            <div class="input">
                <select class="inputs-list span4" name="answerType" id="answerType" style="width:200px">
                    ...
                    <option value="checkboxlist_hidden"><?php echo t('Checkbox List hidden')?></option>
        ...
        <div id="regexSettings" style="display:block">
        <div class="clearfix">
            <label><?php echo t('Text and Number control')?></label>
            <div class="input">
                <select class="regexSettings_1" name="Lregex" id="Lregex" style="width:200px">
                    <option value=""><?php echo t('None')?></option>
                    <option value="text"><?php echo t('Only Text')?></option>
                    <option value="number"><?php echo t('Only Number')?></option>
                </select>
            </div>
        </div>
        </div>
        <div id="answerOptionsArea">
            <div class="clearfix">
                <?php echo $form->label('answerOptions', t('Answer Options EN'))?>
            ...
            <div class="clearfix">
                <?php echo $form->label('answerOptionsLpl', t('Answer Options PL'))?>
                <div class="input">
                    <?php echo $form->textarea('answerOptionsLpl', array('rows' => 3))?>
                </div>
            </div>
            <div class="clearfix">
                <?php echo $form->label('answerOptionsLnl', t('Answer Options NL'))?>
                <div class="input">
                    <?php echo $form->textarea('answerOptionsLnl', array('rows' => 3))?>
                </div>
            </div>
            <div class="clearfix">
                <?php echo $form->label('answerOptionsLes', t('Answer Options ES'))?>
                <div class="input">
                    <?php echo $form->textarea('answerOptionsLes', array('rows' => 3))?>
                </div>
            </div>
        </div>

        <div id="answerSettings" style="display:none">
            <div class="clearfix">
                <?php echo $form->label('width', t('Text Area Width'))?>
                <div class="input">
                    <?php echo $form->text('width', 200)?>
                </div>
            </div>
        </div>
        <div id="answerSettings2" style="display:none">
            <div class="clearfix">
        ...
        <div id="answerSettingsNumber" style="display:none">
            <div class="clearfix">
                <?php echo $form->label('Lmax', t('Maximum value'))?>
                <div class="input">
                    <?php echo $form->text('Lmax', 0)?>
                </div>
            </div>
            <div class="clearfix">
                <?php echo $form->label('Lmin', t('Minim value'))?>
                <div class="input">
                    <?php echo $form->text('Lmin', 0)?>
                </div>
            </div>
        </div>
        <div id="answerSettingsText" style="display:none">
            <div class="clearfix">
                <?php echo $form->label('LminL', t('Minimum Length'))?>
                <div class="input">
                    <?php echo $form->text('LminL', 0)?>
                </div>
            </div>
            <div class="clearfix">
                <?php echo $form->label('LmaxL', t('Maximum Length'))?>
                <div class="input">
                    <?php echo $form->text('LmaxL', 100)?>
                </div>
            </div>
        </div>
        <div class="clearfix">
...
<div id="ccm-formBlockPane-edit" class="ccm-formBlockPane" style=" <?php  echo (intval($miniSurveyInfo['bID'])>0)?'display:block':''?> ">
    ...
    <div id="editQuestionForm" style="display:none">
        <fieldset>
            <legend id="editQuestionTitle"><?php echo t('Edit Question EN *')?></legend>
            <div class="clearfix">
            ...
            <div class="clearfix">
                <?php echo $form->label('Lpl', t('Question PL *'))?>
                <div class="input">
                    <?php echo $form->text('LplEdit')?>
                </div>
            </div>
            <div class="clearfix">
                <?php echo $form->label('Lnl', t('Question NL'))?>
                <div class="input">
                    <?php echo $form->text('LnlEdit')?>
                </div>
            </div>
            <div class="clearfix">
                <?php echo $form->label('Les', t('Question ES'))?>
                <div class="input">
                    <?php echo $form->text('LesEdit')?>
                </div>
            </div>
            ...
            <div class="clearfix">
                <label><?php echo t('Answer Type')?></label>
                <div class="input">
                    <select class="inputs-list span4" name="answerTypeEdit" id="answerTypeEdit" style="width:200px">
                        <option value="field"><?php echo t('Text Field')?></option>
                        <option value="text"><?php echo t('Text Area')?></option>
                        <option value="radios"><?php echo t('Radio Buttons')?></option>
                        <option value="select"><?php echo t('Select Box')?></option>
            ...
            <div id="regexSettingsEdit" style="display:block">
            <div class="clearfix">
                <label><?php echo t('Text and Number control')?></label>
                <div class="input">
                    <select class="regexSettingsEdit_1" name="LregexEdit" id="LregexEdit" style="width:200px">
                        <option value=""><?php echo t('None')?></option>
                        <option value="text"><?php echo t('Only Text')?></option>
                        <option value="number"><?php echo t('Only Number')?></option>
                    </select>
            ...
            <div id="answerOptionsAreaEdit">
                <div class="clearfix">
                    <?php echo $form->label('answerOptionsEdit', t('Answer Options EN'))?>
                    <span class="help-block"><?php echo t(' --->  Put each answer options on a new line')?></span>
                    <div class="input">
                ...
                <div class="clearfix">
                    <?php echo $form->label('answerOptionsLplEdit', t('Answer Options PL'))?>
                    <div class="input">
                        <?php echo $form->textarea('answerOptionsLplEdit', array('rows' => 3))?>
                    </div>
                </div>
                <div class="clearfix">
                    <?php echo $form->label('answerOptionsLnlEdit', t('Answer Options NL'))?>
                    <div class="input">
                        <?php echo $form->textarea('answerOptionsLnlEdit', array('rows' => 3))?>
                    </div>
                </div>
                <div class="clearfix">
                    <?php echo $form->label('answerOptionsLesEdit', t('Answer Options ES'))?>
                    <div class="input">
                        <?php echo $form->textarea('answerOptionsLesEdit', array('rows' => 3))?>
                    </div>
                </div>
            </div>
                <div id="answerSettingsEdit" style="display:none">
                    <div class="clearfix">
                        <?php echo $form->label('widthEdit', t('Text Area Width'))?>
                        <div class="input">
                           <?php echo $form->text('widthEdit', 200)?>
                        </div>
                    </div>
                </div>
            <div id="answerSettings2Edit" style="display:none">
                <div class="clearfix">
            ...
            <div id="answerSettingsNumberEdit" style="display:none">
                <div class="clearfix">
                    <?php echo $form->label('LmaxEdit', t('Maximum value'))?>
                    <div class="input">
                        <?php echo $form->text('LmaxEdit', 0)?>
                    </div>
                </div>
                <div class="clearfix">
                    <?php echo $form->label('LminEdit', t('Minim value'))?>
                    <div class="input">
                        <?php echo $form->text('LminEdit', 0)?>
                    </div>
                </div>
            </div>
            <div id="answerSettingsText" style="display:none">
                <div class="clearfix">
                    <?php echo $form->label('LminLEdit', t('Minimum Length'))?>
                    <div class="input">
                        <?php echo $form->text('LminLEdit', 0)?>
                    </div>
                </div>
                <div class="clearfix">
                    <?php echo $form->label('LmaxLEdit', t('Maximum Length'))?>
                    <div class="input">
                        <?php echo $form->text('LmaxLEdit', 100)?>
                    </div>
                </div>
            </div>
        ...
        <div>
            ...
            <?php echo $ih->button(t('Save Changes'), 'javascript:void(0)', 'right', 'primary', array('id' => 'editQuestion'))  //<a style="float: right" href="javascript:clickedButton = true;$('#ccm-form-submit-button').get(0).click()" class="btn primary">Save <i class="icon-ok icon-white"></i></a>
            ?>
        </div>
    </div>
